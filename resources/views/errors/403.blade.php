...
<body class="error-page">
    <div class="container error-container mt-4">
        ...
        <div class="row">
            <div class="col-12">
                <!-- Replace with a 403-specific error image -->
                <img src="{{ asset('images/error/403.svg') }}" class="img-fluid error-image" alt="403">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <h4 class="error-subtitle mb-3">Oops! Forbidden Access</h4>
                <p class="mb-4">You do not have permission to access this page. Please contact the administrator or return to the home page.</p>
