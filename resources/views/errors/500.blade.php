...
<body class="error-page">
    <div class="container error-container mt-4">
        ...
        <div class="row">
            <div class="col-12">
                <!-- Replace with a 505-specific error image -->
                <img src="{{ asset('images/error/505.svg') }}" class="img-fluid error-image" alt="505">
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-12">
                <h4 class="error-subtitle mb-3">Oops! Internal Server Error</h4>
                <p class="mb-4">Something went wrong on our end. Please try refreshing the page or return to the home page.</p>
