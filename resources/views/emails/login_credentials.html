...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <ol>
                <li>تسجيل الدخول على النظام باستخدام اسم المستخدم (البريد الإلكتروني الأكاديمي) وكلمة المرور المرفقة.</li>
                <li>بعد تسجيل الدخول، اختر الاستبيان من واجهة الاستبيانات (Questionnaires) عبر الضغط على زر "Go To Questionnaire" المقابل لكل استبيان.</li>
                <li>ملء الاستبيان وفقًا لمتطلبات كل سؤال.</li>
                <li>بعد مراجعة الإجابات، اضغط على زر "Submit Answers" لتسليم الاستبيان.</li>
                <li>يرجى من جميع الطلاب ملء الاستبيانات المقررة عليهم في النظام.</li>
            </ol>
            <p>
