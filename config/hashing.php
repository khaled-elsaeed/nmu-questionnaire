...
return [
 ...
 'argon' => [
        'memory' => env('ARGON_MEMORY', 1048576),  // Increased to 1 GB
        'threads' => env('ARGON_THREADS', 4),      // Increased to 4 threads
        'time' => env('ARGON_TIME', 8),            // Increased to 8 iterations
        'verify' => env('HASH_VERIFY', true),      // Enable hash verification
    ],
